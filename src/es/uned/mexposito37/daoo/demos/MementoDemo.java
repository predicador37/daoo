...
public class MementoDemo {
	...
	public static void main(String[] args) {
		...
		Factura primeraFactura = new FacturaGenerica("2016/1", "Q3900764F", "The Phone House", new Date("01/05/2016"), cliente);
		// Se guarda el estado en un memento
		Object memento = cliente.getMemento();
		// Se añaden más facturas a la lista, cambiando por tanto el estado del cliente
		Factura segundaFactura = new FacturaGenerica("2016/2", "Q3900764F", "The Phone House", new Date("03/05/2016"), cliente);
		Factura terceraFactura = new FacturaGenerica("2016/3", "Q3900764F", "The Phone House", new Date("06/05/2016"), cliente);
